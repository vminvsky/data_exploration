...
df = pd.read_csv("/ada1/projects/socialknowledge/data/article_reddit-wiki_partisan_scores_old.csv")


# assume you have a "long-form" data frame
# see https://plotly.com/python/px-arguments/ for more options

fig = px.scatter(df, x="partisan_reddit", y="score", color="GS", hover_data=["page_title","GS"])
...
def update_bar_chart(slider_range,slider_range2,slider_range3):
    ...
    fig = px.scatter(
        df[mask], x="partisan_reddit", y="score", color="GS",
